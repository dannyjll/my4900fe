...
const Navbar = () => {
    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark p-3">
            ...
            <div className={`navbar-collapse ${isNavCollapsed ? 'collapse justify-content-end' : 'justify-content-center'} `} id="navbarNavDropdown" style={{ transition: 'height 0.5s ease' }} >
